      ...
      <nav class="bg-transparent border-gray-200 text-white">
        ...
        <div className='hidden md:flex space-x-16'>
          ...
          <div className='flex-col'>
            <button onClick={handleFindProffesionals} className='inline-flex space-x-2 items-center  text-white'>
          ...
          >
            ...
            <div className='absolute mt-4 text-center divide-y-2 -translate-x-5 w-48 shadow-lg shadow-gray-800 bg-white flex flex-col z-10 '>
               <Link onClick={handleFindProffesionals} to='/FindProfessionals/builder' className='text-black hover:bg-[#994b00] transition-all hover:text-white py-2'>
                Builders
               </Link>
               <Link onClick={handleFindProffesionals} to='/FindProfessionals/Designer' className='text-black py-2 hover:bg-[#994b00] transition-all hover:text-white'>
                Designer
               </Link>
               <Link onClick={handleFindProffesionals} to='/FindProfessionals/supplier' className='text-black py-2 hover:bg-[#994b00] transition-all hover:text-white'>
                Supplier
               </Link>
            </div>)}
          </div>
        ...
        <div class="flex md:order-2">
          ...
          <div class="relative hidden text-white md:block">
            ...
            <input type="text" id="search-navbar" className="pl-10 mt-8 md:mt-0 w-full md:w-72 md:justify-end transition-all  text-white py-2 px-3 rounded-md bg-transparent outline outline-2 focus:outline outline-gray-100 focus:outline-gray-200" placeholder="Search Home"></input>
          </div>
