    ...
    <div className='bg-white-800 p-8 md:ml-20 text-white text-center w-full-z-10'>
      ...
      <div className="relative w-full h-full mb-40 md:flex">
       ...
       <p className="pt-4 text-black text-3xl font-semibold">{user.full_name}</p>
        ...
        <div className='py-3 flex w-full text-center  items-center'>
          ...
          <button className='bg-[#994b00] rounded-full px-7 p-3'>                                    {isOpen && (
                                        <div>
          ...
          <button className='bg-[#994b00] mt-4 rounded-full px-7 p-3'>Request for Quotation</button>
        </div>
      ...
      <div className='md:flex max-w-4xl  text-left md:space-x-5 mt-4 shadow-lg rounded-lg overflow-hidden '>
        <div className='flex-col text-black border p-6 md:p-8 w-full'>
          ...
          <p className='py-6'>We are dedicated to turning your dreams of a perfect home into reality. With a passion for crafting exceptional living spaces, we take pride in our commitment to quality, innovation, and personalized service.
            <br/><br/>Our team of experienced builders, architects, and designers work collaboratively to ensure every project reflects our client's unique vision and requirements. From concept to completion, we are here to guide you through every step of the home-building journey.
            <br/><br/>As a company, we believe in the values of integrity, transparency, and excellence. Our track record of delivering beautifully designed, durable, and energy-efficient homes speaks to our unwavering dedication to the craft.
            <br/><br/>We understand that your home is not just a building; it's a place where memories are made, where your family grows, and where your unique story unfolds. That's why we take the time to listen, understand your needs, and translate them into a home that's a true reflection of your style and values.</p>
      </div>
      </div>
      <div className='md:flex max-w-4xl  text-left md:space-x-5 mt-4 shadow-lg rounded-lg overflow-hidden '>
        ...
        <img className='rounded-[75px] object-cover w-full ' src={img1} alt='Kitchen' />
      ...
      <div className='relative w-1/3'>
        <img className='rounded-[75px] object-cover w-full ' src={img2} alt='Bedroom' />
        <div className='absolute inset-0 rounded-[75px] bg-gradient-to-b from-transparent to-black opacity-60'></div>
        <div className='absolute inset-0  mt-48 flex flex-col px-8 text-2xl font-bold text-white'>
          <p>Bedroom</p>
        </div>
      ...
      <div className='relative w-1/3'>
        <img className='rounded-[75px] object-cover w-full ' src={img3} alt='Living Room' />
        <div className='absolute inset-0 rounded-[75px] bg-gradient-to-b from-transparent to-black opacity-60'></div>
        <div className='absolute inset-0  mt-48 flex flex-col px-8 text-2xl font-bold text-white'>
          <p>Living Room</p>
        </div>
