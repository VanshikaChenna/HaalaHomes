...
import img1 from "../../../images/Builder/12.jpg";
import img2 from "../../../images/Builder/13.jpg";
import img3 from "../../../images/Builder/14.jpg";
import img4 from "../../../images/Builder/15.jpg";
...
export default function UserProfile_post() {
    ...
    const fetchUser = async () => {
        try{
          const response = await api.get(`/users/Builder`);
    ...
    <div className='bg-white-800 p-8 text-white text-center w-full-z-10'>
      <div className='flex flex-col w-full h-full '>
        <div className="absolute items-center inset-0 h-[320px] md:h-[670px]  bg-gradient-to-b from-black to-transparent opacity-85  -z-10"></div>
          ...
          <h1 className=' justify-center text-5xl md:text-7xl  text-white mx-auto font-extrabold '>Builders</h1>
...
<buttton className='p-2 rounded-full  px-4 bg-[#994B00]'>Builder <i className="bg-white px-1 ml-14 rounded-full py-0.5 text-[#994B00] fas fa-times"></i>
</buttton>
</div>
         ...
         <div className='w-full flex-col'>
           <div className='flex py-1'>
             ...
             <div className='flex-col'>
               ...
               <p className=' text-yellow-400 font-bold inline-flex'>{user.rating} <p className='ml-1 -mt-1 text-lg'>&#9733;&#9733;&#9733;&#9733;&#9733;</p></p> 75 Reviews
               </h3>
               </div>
               </div>
               <div> 
           ...
           <div className=' max-w-3xl mt-4'>
             ...
             <div className='w-full mt-2'>
                     ...
                     <p className='text-black mt-2 mb-5 md:mb-0 '>{user.about_us}
