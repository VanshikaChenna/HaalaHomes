      ...
      <div className='md:flex text-left space-x-5 mt-4 p-4 overflow-hidden '>
        ...
        <div className='w-full flex-col'>
          ...
          <div className=' max-w-3xl mt-4'>
            ...
            <i className="fa-solid fas  text-green-700 mt-1 fa-birthday-cake"></i><p>10 Years in Business</p>
            </p>
            <div className='w-full mt-2'>
            {!expanded1 && (
                    <p className='text-black mt-2 mb-5 md:mb-0 '>We specialize in kitchen and living room, custom and semi-custom cabinetry, countertops and tiles. Through personalized consultations, we collaborate with clients at our boutique showroom in Northbrook to create exquisite designs that balance style and function...
            ...
            {expanded1 && (
                <p className="text-black mt-2 mb-5 md:mb-0 ">
                        We specialize in kitchen and living room designs, crafting custom and semi-custom cabinetry, meticulously curated countertops, and intricately designed tiles. Through tailored and personalized consultations, we foster a collaborative environment with our clients at our boutique showroom in Northbrook. Our aim is to craft exquisite designs that strike a harmonious balance between style and functionality, ensuring a space that is not just aesthetically pleasing but also highly functional and reflective of your unique taste and lifestyle preferences. 
                        <span onClick={handleReadMoreClick1} className='font-bold' style={{ color: '#994B00', cursor: 'pointer' }}>
                        Show less
                    </span>
                </p>
