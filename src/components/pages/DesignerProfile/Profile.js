  ...
  return (
    ...
    <div className='bg-white-800 md:ml-20 p-8 text-white text-center w-full-z-10'>
      ...
      <div className="relative w-full h-full mb-40 md:flex">
        ...
        />
        <p className="pt-4 md:py-8 text-black text-3xl font-semibold">Dylan Meringue</p>
      ...
      <div className='md:flex max-w-4xl  text-left md:space-x-5 mt-4 shadow-lg rounded-lg overflow-hidden '>
        <div className='flex-col  border p-6 md:p-14 w-full'>
          <div className='md:flex md:space-x-8'>
            <img src={profilePic} className=' md:h-48 md:w-72 h-80 w-80 p-6 md:p-0 object-cover rounded-full  md:mr-2 border-slate-200'></img>
            <div className='flex-col w-full px-3'>
              <h2 className='text-gray-800 pl-1   md:pb-2 text-md'>
              Company Name
              </h2>
              <div className='w-full'>
                <input type="text" placeholder="" className="mt-2 md:mt-0 w-full md:justify-end   text-gray-500 py-3 px-3 rounded-sm bg-transparent transition-all outline focus:outline outline-gray-100 focus:outline-gray-200" />
              </div>
          ...
          <div className='flex-col w-full space-y-3 px-3 mt-10'>
            ...
            <div className='md:inline-flex justify-evenly py-2 space-y-5 md:space-y-0 md:space-x-3 w-full'>
              <div className='flex-col md:w-1/2 '>
                ...
                <div className='w-full'>
                  <input type="text" placeholder="Dylan Meringue" className="mt-2 md:mt-0 w-full md:justify-end   text-gray-500 py-3 px-3 rounded-sm bg-transparent transition-all outline focus:outline outline-gray-100 focus:outline-gray-200" />
                </div>
                </div>
              <div className='flex-col md:w-1/2 px-3'>
                ...
                <div className='w-full'>
                  <input type="text" placeholder="dylan_meringue@gmail.com" className="mt-2 md:mt-0 w-full md:justify-end   text-gray-500 py-3 px-3 rounded-sm bg-transparent transition-all outline focus:outline outline-gray-100 focus:outline-gray-200" />
                </div>
                </div>
            </div>
            <div className='md:inline-flex justify-evenly py-2 space-y-5 md:space-y-0 md:space-x-3 w-full'>
            ...
            <div className='justify-start py-2 pb-16 pd:mb-4 w-full'>
              <div className='flex-col md:w-1/2 '>
                ...
                <div className='w-full'>
                  <input type="text" placeholder="15 Years" className="mt-2 md:mt-0 w-full md:justify-end   text-gray-500 py-3 px-3 rounded-sm bg-transparent transition-all outline focus:outline outline-gray-100 focus:outline-gray-200" />
                </div>
                </div>
      ...
      {/* Other content in the DesignerProfile component */}
    </div>
    </>
  );
}
