...
export default function UserProfile_post() {
  ...
  return (
    ...
    <div className='bg-white-800 p-8 md:ml-20 text-white text-center w-full-z-10'>
      ...
      <form onSubmit={handleFormSubmit} className='border-0 p-0 bg-transparent'>
        ...
        <div className='flex-col  border p-6 md:p-14 w-full'>
          <div className='md:flex md:space-x-8'>
            ...
            <div className='flex-col w-full px-3'>
              ...
              value={userdata.name} placeholder={user.full_name} className="mt-2 md:mt-0 w-full md:justify-end   text-gray-500 py-3 px-3 rounded-sm bg-transparent transition-all outline focus:outline outline-gray-100 focus:outline-gray-200" />
              </div>
          ...
          <div className='flex-col w-full space-y-3 mt-10'>
            <div className='md:inline-flex justify-evenly py-2 space-y-5 md:space-y-0 md:space-x-3 w-full'>
              <div className='flex-col md:w-1/2 px-3'>
                ...
                <div className='w-full'>
                  <input type="text" id='email' name='email' placeholder={user.email} onChange={handleInputChange}
            ...
            <div className='md:inline-flex justify-evenly py-2 space-y-5 md:space-y-0 md:space-x-3 w-full'>
              ...
              <div className='flex-col md:w-1/2 px-3'>
                ...
                <div className='w-full'>
                  <input type="text" id='provience' name='provience'  onChange={handleInputChange}
            ...
            <div className='justify-start py-2 pb-16 pd:mb-4 w-full'>
              <div className='flex-col md:w-1/2 px-3'>
                ...
                <div className='w-full'>
                  <input type="text" placeholder="T7V 1V1" className="mt-2 md:mt-0 w-full md:justify-end   text-gray-500 py-3 px-3 rounded-sm bg-transparent transition-all outline focus:outline outline-gray-100 focus:outline-gray-200" />
                </div>
                </div>              
            </div>
            <div className='grid md:grid-flow-col mt-10 items-center space-y-5 md:space-y-0 md:space-x-6 w-full justify-stretch'>
                ...
                <button type='submit' className='block uppercase border-2 py-3 md:py-2 text-md rounded-full px-12 p-2 transition-all border-[#994b00] hover:bg-[#994b002a] text-[#994b00]'> Save</button>
