...
export default function UserProfile_wishlist() {
  return (
    ...
    <div className='bg-white-800 md:ml-20 p-8 text-white text-center w-full-z-10'>
      ...
      <div className='md:flex text-left space-x-5 mt-4 shadow-lg rounded-lg overflow-hidden '>
       
        <img src={post} className='h-40 w-full mb-5 md:mb-0 md:h-full md:w-52 object-cover '></img>
        <div className='flex-col'>
          <div className='flex'>
            <img src={profilePic} className='h-14 object-cover rounded-full border-2 mr-2 border-slate-200'></img>
            <div className='flex-col'>
          ...
          <div className=' max-w-lg mt-4'>
            ...
            <p className='text-black mt-2 mb-5 md:mb-0 '>Hi everyone! I want to make my modular home. This is the floor plan so far. I'm wondering about the arrangement of the living, dining, and kitchen areas..........</p>
          </div>
        </div>
      </div>
      </div>
