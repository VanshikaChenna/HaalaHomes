...
const Modal_community = ({ isvisible,onClose}) => {
  ...
  return (
    <div className='fixed top-0  w-full h-full flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm'>
      <form onSubmit={handleSubmit} className=' bg-transparent scale-105 border-0'>
        <div className='bg-white  h-2/3 sm:w-[515px] sm:h-[560px] '>
  ...
  <div><br/></div>
          ...
          <div className='flex  pt-5 pl-60  '>
          <button className='border border-yellow-700 hover:border-slate-500 rounded-3xl shadow-lg hover:bg-yellow-700 h-10 w-24 text-slate-500 hover:text-white' onClick={() => onClose()}>Close</button>
          <div className='mx-5'>
          <button type='submit' className='border border-yellow-700 borderhover:border-slate-500 rounded-3xl shadow-lg hover:bg-yellow-700  text-slate-500 hover:text-white h-10 w-24' >Done</button>
