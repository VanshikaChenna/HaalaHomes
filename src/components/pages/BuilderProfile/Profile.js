          ...
          <div className='md:flex md:space-x-8'>
            ...
            <div className='flex-col w-full px-3'>
              ...
              <div className='w-full'>
                <input type="text" placeholder="Build_Breeze" className="mt-2 md:mt-0 w-full md:justify-end   text-gray-500 py-3 px-3 rounded-sm bg-transparent transition-all outline focus:outline outline-gray-100 focus:outline-gray-200" />
              </div>
          ...
          <div className='flex-col w-full space-y-3 px-3 mt-10'>
            ...
            <div className='md:inline-flex justify-evenly py-2 space-y-5 md:space-y-0 md:space-x-3 w-full'>
              <div className='flex-col md:w-1/2 '>
                ...
                <div className='w-full'>
                  <input type="text" placeholder="John Thomas" className="mt-2 md:mt-0 w-full md:justify-end   text-gray-500 py-3 px-3 rounded-sm bg-transparent transition-all outline focus:outline outline-gray-100 focus:outline-gray-200" />
                </div>
                </div>
              <div className='flex-col md:w-1/2 px-3'>
                ...
                <div className='w-full'>
                  <input type="text" placeholder="thomas.john@gmail.com" className="mt-2 md:mt-0 w-full md:justify-end   text-gray-500 py-3 px-3 rounded-sm bg-transparent transition-all outline focus:outline outline-gray-100 focus:outline-gray-200" />
                </div>
                </div>
            </div>
            <div className='md:inline-flex justify-evenly py-2 space-y-5 md:space-y-0 md:space-x-3 w-full'>
